...
export const addVideo = async (video) => {
  try {
    return await commonAPI("POST", `${SERVEL_URL}/all-Vedios`, video);
...
export const getAllVideos = async () => {
  try {
    return await commonAPI("GET", `${SERVEL_URL}/all-Vedios`, "");
...
export const deleteVideos = async (videoid) => {
  return await commonAPI("DELETE", `${SERVEL_URL}/all-Vedios/${videoid}`, {});
};
//watch history
